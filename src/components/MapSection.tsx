...
const MapSection: React.FC = () => (
    <section id="mapa" className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
                <h2 className="text-sm font-bold text-teal-500 uppercase tracking-wider mb-2">Nossa Presença</h2>
                <h3 className="text-3xl lg:text-4xl font-bold text-white mb-6">Atendemos clientes em todo o território nacional</h3>
            ...
            <div className="h-[450px] w-full rounded-2xl overflow-hidden shadow-2xl shadow-teal-500/20 border border-zinc-800">
                <Mapa />
            </div>
        </div>
    </section>
